...
import 'package:champshop/bodys/approve.dart';
import 'package:champshop/bodys/wait.dart';
import 'package:champshop/bodys/wallet.dart';
import 'package:champshop/models/wallet_model.dart';
import 'package:champshop/utility/my_constant.dart';
import 'package:champshop/widgets/show_no_data.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        unselectedItemColor: MyConstant.primary2,
        selectedItemColor: MyConstant.primary2,
        onTap: (value) {
          setState(() {
            indexWidget = value;
          });
