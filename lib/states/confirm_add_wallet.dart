...
class _ConfirmAddWalletState extends State<ConfirmAddWallet> {
  ...
  Future<void> processUploadAndInsertData() async {
    ...
    String apiSaveSlip = '${MyConstant.domain}/champshop/saveSlip.php';
    ...
    try {
      ...
      await Dio().post(apiSaveSlip, data: data).then((value) async {
        ...
        var urlAPIinsert =
            '${MyConstant.domain}/champshop/insertWallet.php?isAdd=true&idBuyer=$idBuyer&datePay=$dateTimeStr&money=${moneyController.text.trim()}&pathSlip=$pathSlip&status=$status';
